...
get_ipython().run_line_magic('run', './constants.ipynb')
get_ipython().run_line_magic('run', './auxiliary_methods.ipynb')
get_ipython().run_line_magic('run', './item.ipynb')
get_ipython().run_line_magic('run', './bin.ipynb')
class Packer:
    def __init__(self):
        self.bins = [] 
        self.unplaced_items = []
